...
/* Write a StudentPortal smart contract where only the owner can register students into the smart contract.
   Only the owner can update and delete students records. Write other functions that will return students records.
   Student records includes, but not limited to: Name, email, date of birth, lga, country, state
*/